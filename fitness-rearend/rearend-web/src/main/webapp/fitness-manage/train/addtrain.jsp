...
<body>
      ...
      <div class="layui-card-body layui-form" style="padding: 15px;">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="tUsername"  lay-verify="required|tUsername" autocomplete="off" placeholder="请输入教练名称"class="layui-input" >
            </div>
          </div>
          <div class="layui-form-item">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="tel" name="tAge" name="tAge" lay-verify="required" autocomplete="off"  class="layui-input" >
              </div>
            </div>
          </div>
          <div class="layui-form-item">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="tel" name="tAddress" class="layui-input">
              </div>
            </div>
          </div>
  ...
  layui.config({
    ...
    /* 监听提交 */
    form.on('submit(addtrain-from)', function(data){
    	var user = $("#train-form").serialize();
    	console.log(user)
    	$.ajax({
    		url:"${pageContext.request.contextPath}/manage/train",
    		data : user,
    		type:"POST",
    		async:true, //开启异步
    		timeout:5000,
